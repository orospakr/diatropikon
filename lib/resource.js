...
function Resource(type, filename, contents) {
    ...
    if(t == "json") {
        ...
        // instance.  However, we're already in the constructor.
        // Ideally, what we should do is, have this as a .new that
        // returns a new object if resource type is flat, or rather
        // has the entry point manufacture the new instance if type is
        // DSL.
