...
function KubernetesClient(target_url) {
    this.target_url = target_url || "http://localhost:8080";
...
KubernetesClient.prototype.executeRequest = function(path, method) {
    ...
    return new Promise(function(resolve, reject) {
        ...
        request.getAsync(self.target_url + "/api/v1beta1/" + path).spread(function(contents, body) {
