...
function Diatropikon() {
    ...
    Project.new(self, self.project_directory).then(function(project) {
        ...
        if(err instanceof KubernetesError) {
            logger.error("Problem contacting Kubernetes: is your cluster running?", err.stack);
        } else {
