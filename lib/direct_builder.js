...
// {"errorDetail":{"message":"The command [/bin/sh -c wget https://s3.amazonaws.com/Minecraft.Download/verffasdfsdafsions/1.7.10/minecraft_server.1.7.10.jar] returned a non-zero code: 8"},"error":"The command [/bin/sh -c wget https://s3.amazonaws.com/Minecraft.Download/verffasdfsdafsions/1.7.10/minecraft_server.1.7.10.jar] returned a non-zero code: 8"}
